...
const UserAvatar = () => {
  ...
  const logoutHandler = async () => {
    try {
      // Clear tất cả room information và disconnect socket khi logout
      socketManager.clearAllRooms();
      socketManager.disconnect();
      console.log('Socket disconnected and rooms cleared during logout');
